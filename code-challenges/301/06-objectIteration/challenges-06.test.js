...
const totalCharacters = (arr) => {
  ...
  arr.forEach(element => {
    element.name ? output += 1 : output += 0;
    element.spouse ? output += 1 : output += 0;
    output += element.children.length;
  });
  return output;
};
...
const houseSize = (arr) => {
  ...
  arr.forEach(element => {
    ...
    element.name ? obj.members += 1 : obj.members += 0;
    element.spouse ? obj.members += 1 : obj.members += 0;
    obj.members += element.children.length;
